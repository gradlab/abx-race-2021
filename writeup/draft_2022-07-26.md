...
Per-visit antibiotic prescribing rates were similar across racial/ethnic groups, both overall (_p_ = 0.57, $\chi^2$ test) and when stratified by appropriateness (_p_ > 0.05, $\chi^2$ test) (__Table 1__, __Table SXX__). 
