...
__Identifying and classifying antibiotic prescriptions.__ We identified encounters in which oral antibiotics were prescribed using xxxxxxxx (__Supplemental Methods__). We classified these prescriptions as appropriate, potentially appropriate, or inappropriate depending on the diagnosis associated with the encounter using existing methods<sup>x</sup>. 
