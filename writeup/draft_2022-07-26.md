...
Per-visit antibiotic prescribing rates were similar across racial/ethnic groups, both overall and when stratified by appropriateness (__Table 1__, _p_ = 0.57, $\rchi^2$ test). 
...
- We found that white individuals received antibiotics at the highest rate and non-Hispanic, non-Black individuals received them at the lowest rate. 
- We found substantial differences in visit rates across race/ethnicities. 
- Across all races/ethnicities, visits for which antibiotics are not appopriate were by far the most common. 
- Even though antibiotics are rarely prescribed for these visits, the high rate of these visits make them a substantial contributor to overall antibiotic prescribing, and thus also to disparities in antibiotic prescribing across races/ethnicities. 
- In contrast, we found no statistically significant differences between per-visit prescribing rates across races/ethnicities. 
- Together, these findings indicate that disparities in disease and/or access to healthcare are primary contributors to the disparities in _per capta_ antibiotic prescribing rates, while within-office factors likely matter less. 

- Impact: this suggests that we have more work to do to separate the upstream factors that impact antibiotic prescribing. 
- Critically, we still don't know whether this reflects over-prescribing or under-prescribing. 
- How woud we know? We need to run serology studies, study correlates of access to care, and examine rates of long-term sequalae of infections across races/ethnicities. 

- Limitations

- Conclusions: how should we intervene given this knowledge? 


<!--- JID Brief Report: 2000 words, 15 references, 2 inserts--->
<!--- AJE Research Letter: 1500 words, 2 inserts--->
